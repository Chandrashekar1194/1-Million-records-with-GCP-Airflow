...
with DAG(
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='bktglobal-data',  # Replace with your bucket name
        source_objects=['global_health_data.csv'],  # Path to your file in the bucket
        destination_project_dataset_table='august-ensign-480709-q5.staging_dataset1.global_data',  # Replace with your project, dataset, and table name
        source_format='CSV', 
